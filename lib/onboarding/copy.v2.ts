  ...
  resume: {
    ...
    lost: {
      ...
      giveUp: {
        ...
        body: "기록 가져오기 번호는 이전에 사용하던 휴대폰에서 확인할 수 있어요. 번호를 잃어버리면 기록을 가져올 수 없고, 새 마음 기록을 시작해야 해요.",
        privacyTitle: '관리자도 번호를 알 수 없나요?',
        privacyBody:
          '하남이네 힐링펫은 이름·연락처 등 개인정보를 수집하지 않는 익명 서비스예요. 그래서 관리자도 가져오기 번호를 찾아드릴 수 없어요.',
        restart: '처음부터 새로 시작하기',
